<div class="navegacion">
            ...
            <nav>
                ...
                <li id="cuenta" class="listas"><a href="">
                    ...
                    <li class="listas"><a href="RegistroEmpleados.php">
                    <div class="text_icon-container">
                        <div class="icon-container">
                        <i class="fa-solid fa-people-line"></i>
                        </div>    
                        <div class="texto">Empleado</div>
                    </div>
                    </a></li>

                    <li class="listas"><a href="profesion.php">
                    <div class="text_icon-container">
                        <div class="icon-container">
                        <i class="fa-solid fa-user-tie"></i>
                        </div>
                        <div class="texto">Profesión</div>
                    </div>
                    </a></li>

                    <li class="listas"><a href="usuario.php">
                    <div class="text_icon-container">
                        <div class="icon-container">
                    ...
                    <li class="listas"><a href="mesas.php">
                    <div class="text_icon-container">
                        <div class="icon-container">
                        <i class="fa-solid fa-stapler"></i>
                        </div>
                        <div class="texto">Mesas</div>
                    </div>
                    </a></li>
                    ...
                    <li class="listas"><a href="indexh.php">
                    <div class="text_icon-container">
                        <div class="icon-container">
                        <i class="fa-solid fa-chart-simple"></i>
                        </div>
                        <div class="texto">Reportes</div>
                    </div>
                    </a></li>
