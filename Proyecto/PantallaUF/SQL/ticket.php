...
<body>
    ...
    <div class="wrapper">
        <form method="POST" action="crearTicket.php">
            ...
            <select class="form-select form-select-lg mb-3" name="transaccion" id="transaccion">
            ...
            <button type="submit" class="btn btn-warning btn-lg" onclick="ticket('<?php echo $nt;?>');" id="generar" name="submit">Generar</button>
        </form>
    </div>
    <br>
    <div class="wrapper2">
